...
def main_apv():
    ...
    try:
        ...
        os.system('am start https://wa.me/+8801311662738?text=' + tks)
...
........:::..:::::..::........:::.......::::......:::..:::::..:::::
 ...
 [$]~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~[$]
    ...
    Author   : Jakariya AHMAD

    Facebook : facebook.com/Jakariya
...
def R():
			...
			print ("\033[1m [!] Tool    : Jakariya Ahmad")

			print (" [!] Brand   : Jakariya")
